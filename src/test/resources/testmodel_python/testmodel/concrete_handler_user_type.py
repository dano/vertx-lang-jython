...
class ConcreteHandlerUserType(object):
    """
    
    """
    def __init__(self, jval):
        self.jconcreteHandlerUserType = jval

    def handle(self, arg0):
        """"""
        return util.java_to_python(self.jconcreteHandlerUserType.handle(arg0._jdel), hashable=False)

    @property
    def _jdel(self):
        return self.jconcreteHandlerUserType
