...
class SuperInterface1(object):
    """
    
    """
    def __init__(self, jval):
        self.jsuperInterface1 = jval

    def super_method_with_basic_params(self, b, s, i, l, f, d, _bool, ch, _str):
        """"""
