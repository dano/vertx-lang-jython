...
class RefedInterface2(object):
    """
    
    """
    def __init__(self, jval):
        self.jrefedInterface2 = jval

    def get_string(self):
        """"""
        return self.jrefedInterface2.getString()

    def set_string(self, _str):
        """"""
        if _str is not None and isinstance(_str, basestring):
            self.jrefedInterface2.setString(_str)
        else:
